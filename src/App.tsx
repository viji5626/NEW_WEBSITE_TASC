...
function App() {
  useEffect(() => {
    ...
    // Only initialize Lenis on desktop to prevent mobile touch conflict / freezing
  ...
  return (
    <ErrorBoundary>
      <BrowserRouter>
        <BootScreen />
        <ScrollToTop />
        <div className="App relative bg-tasc-bg min-h-screen text-tasc-text selection:bg-tasc-cyan selection:text-slate-900 overflow-x-hidden" data-testid="tasc-app">
          <TechBackground />
          {/* Noise Overlay */}
          <div 
