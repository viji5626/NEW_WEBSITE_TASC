          ...
          {STACK.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-[#0D1117] trace-border group flex flex-col"
              >
                {/* Hero image (if provided) */}
                {s.image && (
                  <div
                    className="relative w-full overflow-hidden border-b border-[#2B313A]"
                  ...
                  >
                    ...
                    />
                    <div className="absolute top-2 left-2 right-2 flex items-center justify-between font-[Orbitron] text-[9px] tracking-[0.3em] text-[#E6EDF3]/80">
                      <span>{s.code}</span>
                ...
                <div className="p-8 md:p-9 flex-1 flex flex-col">
                  ...
                  {!s.image && (
                    <div className="font-[Orbitron] text-[9px] tracking-[0.3em] text-[#E6EDF3]/40 mb-2">{s.code}</div>
                  )}
                  <h3 className="font-[Montserrat] text-xl font-medium text-[#E6EDF3] leading-tight">{s.title}</h3>
                  <div className="mt-1 font-[Orbitron] text-[9px] tracking-[0.2em] text-[#00C2FF]/80">{s.vendor}</div>
                  <p className="mt-4 text-[#E6EDF3]/55 text-sm leading-relaxed font-light">{s.body}</p>
                  <ul className="mt-5 space-y-1.5">
                    {s.bullets.map((b) => (
                      <li key={b} className="flex items-center gap-3 text-[#E6EDF3]/75 text-xs">
